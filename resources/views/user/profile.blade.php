...
<!--BODY-PIC-CONTAINER-->
        <div class="first-pic-container">
            <img src="{{URL::to('WEBSITE ELEMENTS/pic/homepage-first-image.png')}}">
        </div>

        <div class="second-pic-container">
            <img src="{{URL::to('WEBSITE ELEMENTS/pic/homepage-second-image.png')}}">
        </div>

        <div class="third-pic-container">
            <img src="{{URL::to('WEBSITE ELEMENTS/pic/homepage-third-image.png')}}">
        </div>
...
<!--FOOTER-->
        ...
        <footer class="footer-distributed">
            ...
            <div class="footer-left">
                <div class="footer-pic"><img src="{{URL::to('WEBSITE ELEMENTS/brand-logo.png')}}"></div>
