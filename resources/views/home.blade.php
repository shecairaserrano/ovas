...
<!--BODY-PIC-CONTAINER-->
    ...
    <a href="{{url('service')}}">
        <img src="WEBSITE ELEMENTS/pic/homepage-first-image.png">
    </a>
    </div>

    <div class="second-pic-container">
        <img src="WEBSITE ELEMENTS/pic/homepage-second-image.png">
    </div>

    <div class="third-pic-container">
        <img src="WEBSITE ELEMENTS/pic/homepage-third-image.png">
    </div>
